...
const ProductDetail = () => {
  ...
  const handleAddToCart = () => {
    addToCart({
      ...
      price: currentPrice,
      image: cake.image,
      flavor: ['c111', 'c116', 'c122'].includes(cake.id) ? '' : selectedFlavor,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div>
              ...
              {((!priceDependsOnFlavor && cake.id !== 'c90' && cake.id !== 'c95' && cake.id !== 'c96' && cake.id !== 'c111' && cake.id !== 'c116' && cake.id !== 'c122') || cake.id === 'c92' || cake.id === 'c93' || cake.id === 'c97' || cake.id === 'c98' || cake.id === 'c100') && (
                <div className="flex flex-col gap-2 mb-3.5">
                  <div className="text-bakery-pink-vibrant font-bold flex items-center gap-1.5 bg-bakery-pink/5 px-3.5 py-1.5 rounded-full border border-bakery-pink/15 w-fit shadow-sm">
                    {cake.id !== 'c91' && (
